...
P = np.linspace(1,4,7)
for t in P:
    _, states, igd = combust(1100, t*ct.one_atm, {'C2H6':1, 'O2':3.5, 'N2': 13.6}, 'constant temperature', dt= 1e-4)
...
fig1.suptitle(f"Auto-ignition of ethane-air at 1100 K and pressure variation")
...
fig2.suptitle(f"Auto-ignition of ethane-air at 3 atm and initial temperature variation")
