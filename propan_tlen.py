...
P = np.linspace(1,4,7)
for t in P:
    _, states, igd = combust(1100, t*ct.one_atm, {'C3H8':1, 'O2':5}, 'constant temperature', dt= 9e-6)
...
fig1.suptitle(f"Auto-ignition of propane-oxygen at 1100 K and pressure variation")
...
for t in T:
    _, states, igd = combust(t, 3*ct.one_atm, {'C3H8':1, 'O2':5}, 'constant pressure')
...
fig2.suptitle(f"Auto-ignition of propane-oxygen at 3 atm and initial temperature variation")
